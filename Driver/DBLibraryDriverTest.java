...
public class DBLibraryDriverTest {
  private UniversityDBLibrary univDBlib;
  
  public  DBLibraryDriverTest(String username, String password){
  ...
  public static void main(String[] args) {
    try{
      DBLibraryDriverTest dbld = new DBLibraryDriverTest(args[0],args[1]);
